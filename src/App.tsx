...
function ProtectedShell({ children }: { children: ReactNode }) {
  ...
  if (loading) {
    return <div className="flex h-full items-center justify-center text-sm text-slate-600 dark:text-slate-400">Loading…</div>;
  }
...
function App() {
  return (
    <div className="mx-auto h-full max-w-md bg-slate-50 dark:bg-slate-900">
      <Routes>
