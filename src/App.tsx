...
function ProtectedShell({ children }: { children: ReactNode }) {
  ...
  if (loading) {
    return <div className="flex h-full items-center justify-center text-sm text-stone-600 dark:text-stone-400">Loading…</div>;
  }
...
function App() {
  return (
    <div className="mx-auto h-full max-w-md bg-stone-50 pt-[env(safe-area-inset-top)] dark:bg-stone-900">
      <Routes>
